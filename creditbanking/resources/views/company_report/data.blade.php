...
@section('title')
{{trans_choice('general.administrative_report',1)}}
@endsection
@section('content')
    <div class="panel panel-white">
        <div class="panel-heading">
            <h6 class="panel-title">{{trans_choice('general.administrative_report',1)}}</h6>
        ...
        <div class="panel-body">
            <table id="" class="table table-striped table-hover">
                ...
                <tr>
                    <td>
                        <a href="{{url('report/company_report/products_summary')}}">{{trans_choice('general.portfolio_overview',1)}}</a>
                    </td>
                    <td>
