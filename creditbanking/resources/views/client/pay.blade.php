        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h6 class="panel-title">{{ trans_choice('general.online_loan_payment',1) }}</h6>
                ...
                <div class="panel-body">
                    ...
                    <div>
                        ...
                        <button type="submit" class="btn btn-primary" id="pay">{{ trans_choice('general.process_payment',1) }}</button>
                        <p><br></p>
                        {!! Form::close() !!}
                    </div>
                            ...
                            <div class="panel panel-default credit-card-box">
                                <div class="panel-heading display-table">
                                    <div class="row display-tr">
                                        <h3 class="panel-title display-td">{{ trans_choice('general.payment_detail',1) }}</h3>
