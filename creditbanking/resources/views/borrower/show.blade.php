...
@section('title')
    {{trans_choice('general.app_name',1)}} | {{trans_choice('general.client_profile',1)}}
@endsection
@section('content')
                ...
                <div class="content-group">
                        ...
                        <ul class="list-inline list-inline-condensed no-margin-bottom">
                           <!--- <li><a href="{{url('communication/email/create?borrower_id='.$borrower->id)}}"
                            ...
                            <li><a href="{{url('borrower/'.$borrower->id.'/edit')}}"
                                   ...
                                   title="{{trans_choice('general.edit',1)}}"><i class=" icon-pen6"> {{trans_choice('general.modify_client',1)}}</i></a>
                            </li>
                    ...
                    <div class="panel no-border-top no-border-radius-top">
                        <ul class="navigation">
                            ...
                            <li class="navigation-header">{{trans_choice('general.navigation',1)}}</li>
        ...
        <div class="content-detached">
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="profile">
                    <div class="panel panel-white">
                        <div class="panel-heading">
                            <h4 class="panel-title"><!--- --->{{trans_choice('general.client_profile',1)}}<!---{{trans_choice('general.profile',1)}}---></h4>
                            <div class="heading-elements">
                                <!--  <div class="input-group-btn">
                                    <button type="button" class="btn btn-info dropdown-toggle margin"
                                            data-toggle="dropdown">dsfds
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h5><b><!--- --->{{trans_choice('general.basic_information',1)}}<!--- {{trans_choice('general.basic',1)}} {{trans_choice('general.detail',2)}}---></b>
                                    </h5>
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tr>
                                            <td><b>{{trans_choice('general.name_surname',1)}}</b></td>
                                            <td>{{$borrower->title}} {{$borrower->first_name}} {{$borrower->last_name}}</td>
                                        </tr>
                                        
                                          @if($borrower->gender=="Male")
                                        <tr>
                                            <td><b>{{trans_choice('general.gender',1)}}</b></td>
                                            <td>
                            ...
                            {{trans_choice('general.female',1)}}
                                    ...
                                    @endif  
                                        ...
                                        <tr>
                                            <td><b>{{trans_choice('general.identification_number',1)}}</b></td>
                                ...
                                <div class="col-md-6">
                                    <h5>
                                        <b><!--- --->{{trans_choice('general.contact_info',1)}}<!--- {{trans_choice('general.contact',1)}} {{trans_choice('general.detail',2)}}---></b>
                                    </h5>
                                    <table class="table table-striped table-hover">
                                        <tr>
                                    ...
                                    <h5>
                                        <b><!--- --->{{trans_choice('general.scanned_document',1)}}<!--- {{trans_choice('general.file',2)}}---></b>
                                    </h5>
                                    <a data-toggle="collapse" data-parent="#accordion" href="#viewFiles">{{trans_choice('general.click_here_to_list_document',1)}}<!---
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h5><b><!--- --->{{trans_choice('general.additional_info',1)}}<!--- {{trans_choice('general.custom_field',2)}}---></b></h5>
                                    <table class="table table-striped table-hover">
                ...
                <div class="tab-pane fade in " id="loans">
                    <div class="panel panel-white">
                        <div class="panel-heading">
                            <h3 class="panel-title">{{trans_choice('general.customer_loan_history',1)}}<!---{{trans_choice('general.loan',2)}}---></h3>
                ...
                <div class="tab-pane fade in " id="payments">
                    <div class="panel panel-white">
                        <div class="panel-heading">
                            <h3 class="panel-title">{{trans_choice('general.customer_payment_history',1)}}<!---{{trans_choice('general.repayment',2)}}---></h3>
                            <div class="heading-elements">
