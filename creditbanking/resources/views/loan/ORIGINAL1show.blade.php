        ...
        <div class="col-md-12">
            <div class="panel border-left-lg border-left-primary">
                <div class="panel-heading">
                    <h6 class="panel-title">Perfil del Cliente<!---{{trans_choice('general.borrower',1)}} {{trans_choice('general.detail',2)}}---></h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 form-horizontal">
                            <div class="form-group">
                                <label class="control-label col-md-4"><strong>Nombre Cliente<!---{{trans_choice('general.name',1)}}--->
                                        :</strong></label>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4"><strong>Codigo Referencia<!---{{trans_choice('general.id',1)}}
                                        --->
                                        :</strong></label>
                                <div class="col-md-8" style="padding-top: 9px;">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4"><strong>Genero<!---{{trans_choice('general.gender',1)}}
                                        --->
                                        :</strong></label>
                                <div class="col-md-8" style="padding-top: 9px;">
                        ...
                        <div class="col-md-3 form-horizontal">
                            <div class="form-group">
                                <label class="control-label col-md-4"><strong>Edad<!---{{trans_choice('general.age',1)}}
                                        :---></strong></label>
                                <div class="col-md-8" style="padding-top: 9px;">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4"><strong>Telefono Residencial<!--{{trans_choice('general.phone',1)}}--->
                                        :</strong></label>
                                <div class="col-md-8" style="padding-top: 9px;">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4"><strong>Correo Electronico<!---{{trans_choice('general.email',1)}}--->
                                        :</strong></label>
                                <div class="col-md-8" style="padding-top: 9px;">
                        ...
                        <div class="col-md-3 form-horizontal">
                            <div class="form-group">
                                <label class="control-label col-md-4"><strong>Empresa donde labora<!---{{trans_choice('general.business',1)}}
                                        :---></strong></label>
                                <div class="col-md-8" style="padding-top: 9px;">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4"><strong>Direccion donde reside <!---{{trans_choice('general.address',1)}}--->
                                        :</strong></label>
                                <div class="col-md-8" style="padding-top: 9px;">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-4"><strong>Pais de residencia<!---{{trans_choice('general.country',1)}}
                                        --->:</strong></label>
                    ...
                    <ul class="nav nav-tabs bg-success">
                        @if($loan->status=="disbursed" || $loan->status=="closed" || $loan->status=="withdrawn" || $loan->status=="written_off" || $loan->status=="rescheduled" )
                            <li class=""><a href="#transactions" data-toggle="tab"
                                            aria-expanded="true"><strong>Transacciones</strong><!---{{trans_choice('general.transaction',2)}}---></a></li>
                            <li><a href="#loan_schedule" data-toggle="tab"
                                   aria-expanded="false"><strong>CALENDARIO DE PAGOS</strong><!---{{trans_choice('general.loan',1)}}
                                    {{trans_choice('general.schedule',1)}}---></a></li>
                            <li class=""><a href="#pending_dues" data-toggle="tab"
                                            aria-expanded="false"><strong>BALANCE GENERAL</strong><!---{{trans_choice('general.summary',1)}}---></a>
                            </li>

                        @endif
                        <li class="active"><a href="#loan_terms" data-toggle="tab"
                                              aria-expanded="false"><strong>DETALLES DEL PRESTAMO</strong><!--{{trans_choice('general.detail',2)}}---></a>
                        </li>

                        <li class=""><a href="#loan_collateral" data-toggle="tab"
                                        aria-expanded="false"><strong>GARANTIAS PIGNORADAS</strong><!---{{trans_choice('general.loan',1)}} {{trans_choice('general.collateral',1)}}---></a>
                        </li>
                        <li class=""><a href="#loan_guarantors" data-toggle="tab"
                                        aria-expanded="false"><strong>GARANTE</strong><!--{{trans_choice('general.loan',1)}} {{trans_choice('general.guarantor',2)}}---></a>
                        </li>
                        <li class=""><a href="#loan_files" data-toggle="tab"
                                        aria-expanded="false"><strong>DOCUMENTOS ADJUNTOS</strong><!---{{trans_choice('general.loan',1)}} {{trans_choice('general.file',2)}}---></a>
                        </li>
                        <li class=""><a href="#loan_comments" data-toggle="tab"
                                        aria-expanded="false"><strong>MEMOS</strong><!---{{trans_choice('general.loan',1)}} {{trans_choice('general.comment',2)}}--></a>
                        </li>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="table-responsive">
                                                    <table id="repayments-data-table"
                                                        ...
                                                        <tr>
                                                            <th>
                        <!-- -->Referencia<!-- {{trans_choice('general.id',1)}}
                                      -->                      </th>
                                                            <th>
                        <!-- -->Fecha Efectiva<!-- {{trans_choice('general.date',1)}}
                                                            --> </th>
                                                            <th>
                                              <!-- -->Fecha Procesamiento<!--                   {{trans_choice('general.submitted',1)}} {{trans_choice('general.on',1)}}-->
                                                            </th>
                                                            <th>
                                                      <!-- -->Tipo de Transaccion<!--           {{trans_choice('general.type',1)}}-->
                                                            </th>

                                                            <th>
                                                              <!-- -->Debito<!--   {{trans_choice('general.debit',1)}}-->
                                                            </th>
                                                            <th>
                                                              <!-- -->Credito<!--   {{trans_choice('general.credit',1)}}-->
                                                            </th>
                                                            <th>
                                                              <!-- -->Balance<!--   {{trans_choice('general.balance',1)}}-->
                                                            </th>
                                                            <th>
                                                              <!-- -->Detalles<!--   {{trans_choice('general.detail',2)}}-->
                                                            </th>
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="input-group-btn">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li>
                                                    <a href="{{url('loan/'.$loan->id.'/schedule/pdf')}}"
                                                       target="_blank">Descargar  en PDF</a>
                                                </li>
                                            ...
                                            <a href="{{url('loan/'.$loan->id.'/schedule/excel')}}"
                                               target="_blank">Descargar en Excel</a></li>
                                    ...
                                    <div class="panel-body table-responsive no-padding">
                                        <table class="table table-bordered table-condensed table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    <b><!-- -->Fecha Pautada<!-- {{trans_choice('general.date',1)}}--></b>
                                                </th>
                                                <th style="text-align:right;">
                                                    <b><!-- -->Pago recibido<!-- {{trans_choice('general.paid',1)}} {{trans_choice('general.by',1)}}--></b>
                                                </th>
                                                <th>
                                                    <b><!-- -->Tipo Transaccion<!-- {{trans_choice('general.description',1)}}--></b>
                                                </th>
                                                <th style="">
                                                    <b><!-- -->Capital<!-- {{trans_choice('general.principal',1)}}--></b>
                                                </th>
                                                <th style="text-align:right;">
                                                    <b><!-- -->Interes<!-- {{trans_choice('general.interest',1)}}--></b>
                                                </th>
                                                <th style="text-align:right;">
                                                    <b><!-- -->Cargos<!-- {{trans_choice('general.fee',2)}}--></b>
                                                </th>
                                                <th style="text-align:right;">
                                                    <b><!-- -->Mora<!-- {{trans_choice('general.penalty',1)}}--></b>
                                                </th>

                                                <th style="text-align:right;">
                                                    <b><!-- -->Cuota Total<!--  {{trans_choice('general.due',1)}}--></b>
                                                </th>
                                                <th style="text-align:right;">
                                                    <b><!-- -->Cuota Pagada<!-- {{trans_choice('general.paid',1)}}--></b>
                                                </th>
                                                <th style="text-align:right;">
                                                    <b><!-- -->Pendiente<!-- {{trans_choice('general.pending',1)}} {{trans_choice('general.due',1)}}--></b>
                                                </th>
                                                <th style="text-align:right;">
                                                    <b><!-- -->Balance<!-- {{trans_choice('general.principal',1)}} {{trans_choice('general.balance',1)}}--></b>
                                                </th>
                                            </tr>
                                            <?php
                                ...
                                <div class="tab_content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-6"><h6>
                                                        <b><!--- --->Ultimo Pago<!--- {{trans_choice('general.last',1)}} {{trans_choice('general.payment',1)}}
                                                            :---></b></h6></div>
                                                <div class="col-md-6">
                                                    <?php
                        $last_payment = \App\Models\LoanTransaction::where('loan_id',
                                                    ...
                                                    @if(!empty($last_payment))
                                                        <h6><b>$ {{number_format($last_payment->credit)}}
                                                                en fecha {{$last_payment->date}}</b></h6>
                                                    @else
                                                        ----
                                                    @endif
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6"><h6>
                                                        <b><!--- --->Proximo Pago<!--- {{trans_choice('general.next',1)}} {{trans_choice('general.payment',1)}}
                                                            :---></b></h6></div>
                                                <div class="col-md-6">
                                                    <?php
                                                    $count = \App\Models\LoanSchedule::where('due_date', '<=',
                                                    ...
                                                    @foreach($next_payment as $key=>$value)
                                                        <?php
                                                        if ($key > date("Y-m-d")) {
                                                            echo ' <h6><b>' . ' $ ' . number_format($value) . ' en fecha ' . $key . '</b></h6>';
                                                            break;
                                                        }
                                                        ?>
                                                    @endforeach
                                            ...
                                            <!--- <div class="row">
                                                <div class="col-md-6"><h6>
                                                        <b>dfdfdff{{trans_choice('general.last',1)}} {{trans_choice('general.payment',1)}} {{trans_choice('general.expected',2)}}
                                                            :</b></h6></div>
                                                <div class="col-md-6">
                                                    <h6>
                                    ...
                                    <table class="table table-bordered table-condensed">
                                        ...
                                        <tr class="bg-danger">
                                            <th width="200">
                                                <b><!--- --->Balances<!--- {{trans_choice('general.item',1)}}
                                                    :---></b>
                                            </th>
                                            <th style="text-align:right;">
                                                <b><!--- --->Capital<!---{{trans_choice('general.principal',1)}}---></b>
                                            ...
                                            <th style="text-align:right;">
                                                <b><!--- --->Total<!--- {{trans_choice('general.total',1)}}---></b>
                                            </th>
                                        </tr>
                                        <tr>
                        ...
                        <div class="tab-pane active" id="loan_terms">
                            ...
                            <div class="panel-body no-padding">
                                <table class="table table-condensed">
                                    ...
                                    <tr>
                                        <td>
                                            <b><!-- -->Estatus del Prestamo <!-- {{trans_choice('general.loan',1)}} {{trans_choice('general.status',1)}}--></b>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="200">
                                            <b><!-- -->Prestamo Numero<!-- {{trans_choice('general.loan',1)}} {{trans_choice('general.application',1)}} {{trans_choice('general.id',1)}}--></b>
                                        </td>
                                        <td>000{{$loan->id}}</td>
                                    ...
                                    <tr>
                                        <td>
                                            <b><!-- --> Tipo de Producto<!--{{trans_choice('general.loan',1)}} {{trans_choice('general.product',1)}}--></b>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <b>Monto Aprobado<!--{{trans_choice('general.principal',1)}} {{trans_choice('general.amount',1)}}--></b>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <b><!-- -->Fecha de Desembolso<!-- {{trans_choice('general.loan',1)}} {{trans_choice('general.release',1)}} {{trans_choice('general.date',1)}}--></b>
                                        </td>
                                        <td>
<?php
...
?>                                            
                                    ...
                                    <tr>
                                        <td>
                                            <b>Metodo de Interes<!--{{trans_choice('general.loan',1)}} {{trans_choice('general.interest',1)}} {{trans_choice('general.method',1)}}--></b>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <b><!-- -->Tasa de Interes<!-- {{trans_choice('general.loan',1)}} {{trans_choice('general.interest',1)}}--></b>
                                        </td>
                ...
                @endif                                        
                                    ...
                                    <tr>
                                        <td>
                                            <b><!-- -->Duracion<!-- {{trans_choice('general.loan',1)}} {{trans_choice('general.duration',1)}}--></b>
                                        </td>
                ...
                @endif                                            
                                    ...
                                    <tr>
                                        <td><b><!-- -->Frecuencia de Pago<!-- {{trans_choice('general.repayment_cycle',1)}}--></b></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><b><!-- -->Cantidad de Pagos<!-- {{trans_choice('general.number',1)}}
                                    ...
                                    <tr>
                                        <td>
                                            <b><!-- -->Comienza a Pagar<!-- {{trans_choice('general.first',1)}} {{trans_choice('general.repayment',1)}} {{trans_choice('general.date',1)}}--></b>
                                        </td>
                                        <td>
<?php
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            {!!  Form::label('loan_disbursed_by_id',"Desembolsado por",array('class'=>' control-label')) !!}
