    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="form-group">
                {!! Form::label('loan_product_id',trans_choice('general.route',1).' '.trans_choice('general.of',1).' '.trans_choice('general.prestamo',1)." *",array('class'=>'col-sm-3 control-label')) !!}
                <div class="col-sm-5">
...
<!---{!! Form::select('interest_method',array('flat_rate'=>trans_choice('general.flat_rate',1)),$loan_product->interest_method, array('class' => 'form-control','required'=>'required')) !!}--->
            ...
            <div class="form-group">
                {!! Form::label('files',trans_choice('general.attach_contract',1).' '.trans_choice('general.of',1).' '.trans_choice('general.prestamo',1),array('class'=>'col-sm-3 control-label')) !!}
                <div class="col-sm-5">
