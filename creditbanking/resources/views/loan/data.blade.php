...
@section('title')
    {{trans_choice('general.loan_portfolio',2)}}
@endsection
@section('content')
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h6 class="panel-title">
                ...
                @if(isset($_REQUEST['status']))
                    ...
                    @endif
                @else
                 {{trans_choice('general.loan_portfolio_report',2)}}
                @endif
            </h6>
        ...
        <div class="panel-body table-responsive">
            <table id="data-table" class="table table-striped table-condensed table-hover">
                ...
                <tr class="bg-primary">
                    <th>#</th>
                    <th>{{trans_choice('general.customer_name',2)}}</th>
                    <th>{{trans_choice('general.capital',2)}}</th>
                    <th>{{trans_choice('general.current_balance',2)}}</th>
                    <th>{{trans_choice('general.disbursement_date',2)}}</th>
                    <th>{{trans_choice('general.route',2)}}</th>
                    <th>{{trans_choice('general.status',2)}}</th>
                ...
                @foreach($data as $key)
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <span class="label label-danger">{{trans_choice('general.not_found',2)}}<i class="fa fa-exclamation-triangle"></i> </span>
                            @endif
                        </td>
                        <td>
