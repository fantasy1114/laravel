...
@section('title')
    {{trans_choice('general.loan_calculator',1)}}
@endsection
@section('content')
    <div class="panel panel-white">
        <div class="panel-heading">
            <h6 class="panel-title">{{trans_choice('general.add_loan_details',1)}}</h6>
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    {!! Form::number('loan_duration',null, array('class' => 'form-control', 'placeholder'=>"0",'required'=>'required','id'=>'loan_duration')) !!}
                </div>
                <div class="col-sm-2">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    {!! Form::select('repayment_cycle',array('daily'=>trans_choice('general.daily',1),'weekly'=>trans_choice('general.weekly',1),'bi_monthly'=>trans_choice('general.bi_monthly',1), 'monthly'=>trans_choice('general.monthly',1)),null, array('class' => 'form-control',"id"=>"repayment_cycle",'required'=>'required')) !!}
                </div>
            </div>
            <hr>
            <div class="form-group">
            ...
            <div class="form-group">
                {!! Form::label('first_payment_date',trans_choice('general.date',1).' '.trans_choice('general.of',1).' '.trans_choice('general.first',1).' '.trans_choice('general.repayment',1),array('class'=>'col-sm-3 control-label')) !!}
                <div class="col-sm-3">
            ...
            <div class="form-group">
                {!! Form::label('interest_method',trans_choice('general.method',1).' '.trans_choice('general.of',1).' '.trans_choice('general.interest',1),array('class'=>'col-sm-3 control-label')) !!}
                <div class="col-sm-5">
            ...
            <div class="form-group">
                {!! Form::label('interest_rate',trans_choice('general.interest_rate',1) . ' %',array('class'=>'col-sm-3 control-label')) !!}
                <div class="col-sm-2">
                    {!! Form::text('interest_rate',null, array('class' => 'form-control touchspin', 'placeholder'=>"",'required'=>'required')) !!}
                </div>
                <div class="col-sm-3">
                    {!! Form::select('interest_period',array('month'=>trans_choice('general.per_month',1)),null, array('class' => 'form-control', "id"=>"inputDefaultInterestPeriod",'required'=>'required')) !!}
                </div>
            </div>
