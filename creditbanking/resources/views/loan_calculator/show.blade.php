...
@section('title')
    {{trans_choice('general.loan_detail',1)}}
@endsection
@section('content')
    <?php
        ...
        <div class="panel-body table-responsive no-padding">
            <table id="" class="table table-bordered table-condensed table-hover">
                ...
                <tr class="bg-primary">
                    ...
                    <th>{{trans_choice('general.last_payment',1)}}</th>
                    <th>{{trans_choice('general.frequency',1)}}</th>
                    <th>{{trans_choice('general.capital',1)}}</th>
                    <th>{{trans_choice('general.rate',1)}} %</th>
                    <th>{{trans_choice('general.total_interest',1)}}</th>
                    <!---<th>Ajustes</th>--->
    ...
    <div class="box box-info">
        <div class="panel-heading">
            <h3 class="panel-title">{{trans_choice('general.payment_calendar',1)}}</h3>
        ...
        <div class="panel-body table-responsive no-padding">
            ...
            <table class="table table-bordered table-condensed  table-hover">
                ...
                <tr class="bg-primary">
                    ...
                    <th></th>
                    <th>{{trans_choice('general.share',1)}}</th>
