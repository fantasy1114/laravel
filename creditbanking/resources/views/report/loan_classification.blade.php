    ...
    <div class="panel panel-white">
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                <button class="btn btn-sm btn-success hidden-print" onclick="window.print()">Imprimir</button>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-xs-2">
                        <span class="input-group-btn">
                          <button type="submit" class="btn bg-success btn-flat">{{trans_choice('general.search',1)}}!
                          </button>
                        </span>
                        <span class="input-group-btn">
                          <a href="{{Request::url()}}"
