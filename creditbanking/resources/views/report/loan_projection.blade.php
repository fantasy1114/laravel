...
@section('content')
    ...
    <h4>{{trans_choice('general.projection',1)}} de {{trans_choice('general.loan',1)}} </h4>
    <div class="row">
        <div class="col-md-12">
            <!-- AREA CHART -->
            <!-- LINE CHART -->
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h6 class="panel-title">{{trans_choice('general.projection',1)}} de {{trans_choice('general.loan',1)}}</h6>
