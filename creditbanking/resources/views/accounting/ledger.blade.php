                ...
                <div class="row">
                    <div class="col-xs-2">
                        <span class="input-group-btn">
                          <button type="submit" class="btn btn-info">{{trans_choice('general.search_for',1)}}<!---{{trans_choice('general.search',1)}}!--->
                          </button>
                        </span>
                        <span class="input-group-btn">
                          <a href="{{Request::url()}}"
                             class="btn bg-purple  btn-flat pull-right">{{trans_choice('general.reset',1)}}<!---{{trans_choice('general.reset',1)}}!---></a>
                        </span>
                        <span class="input-group-btn">
                            <button class="btn btn-info" onclick="window.print()">{{trans_choice('general.print',1)}}</button> 
                        </span>
                    </div>
                </div>
            </div>
