...
@section('title')
    {{trans_choice('general.app_name',1)}} | {{trans_choice('general.route_report',1)}}
@endsection
@section('content')
    <div class="panel panel-white">
        <div class="panel-heading">
            <h6 class="panel-title">{{trans_choice('general.route_report',1)}}</h6>

            <div class="heading-elements">
                <a href="{{ url('loan/loan_product/create') }}"
                   class="btn btn-info btn-sm">{{trans_choice('general.add_route',1)}}</a>
            </div>
        </div>
        <div class="panel-body">
            <table id="" class="table table-bordered table-hover">
                ...
                <tr>
                    <th>{{trans_choice('general.route',1)}}</th>
